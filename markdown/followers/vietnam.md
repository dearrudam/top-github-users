...
The `number of followers` of users in Vietnam on `2024/6/13 12:48 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
