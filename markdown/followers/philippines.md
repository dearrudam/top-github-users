...
The `number of followers` of users in Philippines on `2025/1/14 1:36 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
