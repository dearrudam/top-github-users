...
The `number of followers` of users in Philippines on `2024/1/9 12:46 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
