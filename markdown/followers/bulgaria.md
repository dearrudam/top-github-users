...
The `number of followers` of users in Bulgaria on `2024/10/9 12:40 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
