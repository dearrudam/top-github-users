...
The `number of followers` of users in Finland on `2024/8/6 12:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
