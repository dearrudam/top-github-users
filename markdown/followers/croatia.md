...
The `number of followers` of users in Croatia on `2024/9/7 1:00 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
