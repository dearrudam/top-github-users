...
The `number of followers` of users in Slovenia on `2024/9/27 1:03 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
