...
The `number of followers` of users in Nicaragua on `2024/9/21 1:31 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
