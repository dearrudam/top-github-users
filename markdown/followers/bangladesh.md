...
The `number of followers` of users in Bangladesh on `2024/9/2 12:15 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
