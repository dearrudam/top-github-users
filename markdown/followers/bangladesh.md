...
The `number of followers` of users in Bangladesh on `2024/4/12 12:45 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
