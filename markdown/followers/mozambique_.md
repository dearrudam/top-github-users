...
The `number of followers` of users in Mozambique  on `2024/11/30 1:40 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
