...
The `number of followers` of users in Mozambique  on `2024/8/16 12:56 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
