...
The `number of followers` of users in Colombia on `2024/12/26 1:37 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
