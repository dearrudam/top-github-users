...
The `number of followers` of users in Colombia on `2024/6/29 1:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
