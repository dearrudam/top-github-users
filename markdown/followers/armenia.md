...
The `number of followers` of users in Armenia on `2024/1/31 1:42 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
