...
The `number of followers` of users in Jordan on `2024/2/29 12:42 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
