...
The `number of followers` of users in Jordan on `2024/9/15 12:15 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
