...
The `number of followers` of users in Botswana on `2025/3/10 12:13 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
