...
The `number of followers` of users in Botswana on `2024/7/31 12:10 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
