...
The `number of followers` of users in Botswana on `2024/4/16 12:41 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
