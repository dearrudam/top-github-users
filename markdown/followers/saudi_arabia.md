...
The `number of followers` of users in Saudi Arabia on `2024/10/31 1:05 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
