...
The `number of followers` of users in Poland on `2024/5/27 12:49 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
