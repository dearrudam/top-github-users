...
The `number of followers` of users in Mauritania on `2024/3/7 12:30 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
