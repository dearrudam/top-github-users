...
The `number of followers` of users in Mauritania on `2024/9/18 12:54 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
