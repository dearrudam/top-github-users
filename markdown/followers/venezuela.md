...
The `number of followers` of users in Venezuela on `2024/11/7 1:02 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
