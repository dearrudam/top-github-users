...
The `number of followers` of users in Venezuela on `2024/1/26 12:43 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
