...
The `number of followers` of users in Venezuela on `2024/4/4 12:45 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
