...
The `number of followers` of users in Switzerland on `2024/6/6 12:53 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
