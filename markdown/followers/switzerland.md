...
The `number of followers` of users in Switzerland on `2024/8/25 1:03 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
