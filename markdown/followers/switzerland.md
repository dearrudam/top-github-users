...
The `number of followers` of users in Switzerland on `2024/12/12 1:10 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
