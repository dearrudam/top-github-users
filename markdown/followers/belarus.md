...
The `number of followers` of users in Belarus on `2024/4/12 1:43 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
