...
The `number of followers` of users in Palestine on `2024/9/23 12:14 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
