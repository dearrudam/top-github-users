...
The `number of followers` of users in Palestine on `2024/10/28 1:06 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
