...
The `number of followers` of users in Kenya on `2025/3/22 12:44 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
