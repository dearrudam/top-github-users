...
The `number of followers` of users in El Salvador on `2024/8/5 1:29 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
