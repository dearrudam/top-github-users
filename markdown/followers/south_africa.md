...
The `number of followers` of users in South Africa on `2024/8/24 12:14 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
