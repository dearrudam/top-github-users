...
The `public contributions` by users in Finland on `2024/10/15 12:42 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
