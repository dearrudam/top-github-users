...
The `public contributions` by users in Finland on `2024/2/19 1:44 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
