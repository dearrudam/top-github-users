...
The `public contributions` by users in Bulgaria on `2025/3/10 1:00 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
