...
The `public contributions` by users in Jordan on `2024/7/7 1:31 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
