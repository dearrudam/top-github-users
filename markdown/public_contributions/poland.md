...
The `public contributions` by users in Poland on `2024/8/20 1:00 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
