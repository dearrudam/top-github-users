...
The `public contributions` and `private contributions` by users in Mali on `2025/1/7 1:00 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
