...
The `public contributions` and `private contributions` by users in Iran on `2025/1/2 1:06 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
