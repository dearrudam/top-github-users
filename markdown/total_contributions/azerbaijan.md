...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/10/6 1:07 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
