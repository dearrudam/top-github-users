...
The `public contributions` and `private contributions` by users in Latvia on `2024/5/11 12:45 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
