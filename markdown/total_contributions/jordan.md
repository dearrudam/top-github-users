...
The `public contributions` and `private contributions` by users in Jordan on `2024/11/25 12:43 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
