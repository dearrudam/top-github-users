...
The `public contributions` and `private contributions` by users in Jordan on `2024/8/11 12:39 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
