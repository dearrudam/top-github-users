...
The `public contributions` and `private contributions` by users in Mauritania on `2024/5/15 1:45 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
