...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/7/14 1:01 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
