...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/8/18 12:14 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
