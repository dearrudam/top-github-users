...
The `public contributions` and `private contributions` by users in Bulgaria on `2024/7/31 12:51 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
