...
The `public contributions` and `private contributions` by users in Tanzania on `2024/9/30 12:14 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
