...
The `public contributions` and `private contributions` by users in Tanzania on `2024/8/26 12:13 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
