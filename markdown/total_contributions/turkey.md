...
The `public contributions` and `private contributions` by users in Turkey on `2025/3/1 1:11 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
