...
The `public contributions` and `private contributions` by users in Ukraine on `2025/1/24 1:37 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
