...
The `public contributions` and `private contributions` by users in Ukraine on `2024/4/1 12:49 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
