...
The `public contributions` and `private contributions` by users in Ecuador on `2024/4/26 1:45 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
