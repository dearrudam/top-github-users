...
The `public contributions` and `private contributions` by users in Palestine on `2024/7/15 1:28 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
