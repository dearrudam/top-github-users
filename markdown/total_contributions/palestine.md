...
The `public contributions` and `private contributions` by users in Palestine on `2024/3/16 12:41 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
