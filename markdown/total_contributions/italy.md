...
The `public contributions` and `private contributions` by users in Italy on `2025/1/3 1:06 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
