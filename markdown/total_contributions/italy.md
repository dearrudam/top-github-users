...
The `public contributions` and `private contributions` by users in Italy on `2024/5/7 12:46 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
