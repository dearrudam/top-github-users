...
The `public contributions` and `private contributions` by users in Norway on `2024/5/23 12:47 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
