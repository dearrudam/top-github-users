...
The `public contributions` and `private contributions` by users in Egypt on `2025/2/7 1:38 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
