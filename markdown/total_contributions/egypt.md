...
The `public contributions` and `private contributions` by users in Egypt on `2024/8/5 12:59 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
