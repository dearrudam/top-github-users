...
The `public contributions` and `private contributions` by users in Egypt on `2024/4/27 12:44 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
