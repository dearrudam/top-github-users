...
The `public contributions` and `private contributions` by users in Finland on `2024/11/20 12:43 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
