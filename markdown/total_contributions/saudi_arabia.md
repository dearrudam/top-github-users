...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2024/9/26 12:14 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
