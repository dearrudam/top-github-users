...
The `public contributions` and `private contributions` by users in Lithuania on `2024/7/9 12:36 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
