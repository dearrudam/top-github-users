...
The `public contributions` and `private contributions` by users in Lithuania on `2024/3/3 12:45 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
